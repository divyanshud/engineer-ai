...
class SecretCodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create secret_code" do
    assert_difference('SecretCode.count') do
      post secret_codes_url, params: { secret_code: { coded_value: @secret_code.coded_value, user_id: @secret_code.user_id } }
    end
  ...
  test "should update secret_code" do
    patch secret_code_url(@secret_code), params: { secret_code: { coded_value: @secret_code.coded_value, user_id: @secret_code.user_id } }
